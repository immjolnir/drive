...
namespace vot
{
    ...
    std::ostream& operator<<(std::ostream& out, const Config::Sequence& seq) {
    ...
    std::pair<const Config::Sequence&, bool> Config::get(const std::string& sequence_name) {
        static const Config::Sequence empty;
